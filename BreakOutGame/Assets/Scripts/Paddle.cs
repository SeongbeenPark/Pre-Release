...
public class Paddle : MonoBehaviour
{
    ...
    public IEnumerator BallCollsionEnter2D(Transform ThisBallTr, Rigidbody2D ThisBallRg, Ball ThisBallCs, GameObject Col, Transform ColTr, SpriteRenderer ColSr, Animator ColAni)
    {
        if (!isStart) yield braek;

        switch (Col.name)
        {
            case "Paddle":
                ThisBallRg.linearVelocity = Vector2.zero;
